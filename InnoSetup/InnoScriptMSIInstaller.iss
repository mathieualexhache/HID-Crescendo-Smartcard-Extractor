...
#define MyAppName "GCSI HID Smartcard Serial Extractor"
...
[Run]
Filename: "powershell.exe"; Parameters: "-File ""{app}\CheckAndInstallPwsh.ps1"""; Flags: runhidden; StatusMsg: "Checking for PowerShell 7 installation and installing PnP.PowerShell module if necessary."
